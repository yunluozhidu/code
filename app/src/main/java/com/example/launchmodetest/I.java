...
public class I extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("singleInstance","I Task id is "+getTaskId());
        ...
        btnGoG.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(I.this, G.class));
            }
        });
        btnGoH.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(I.this, H.class));
            }
        });
        binGoI.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(I.this, I.class));
            }
        });
